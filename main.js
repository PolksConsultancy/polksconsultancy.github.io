                ...
                if(fieldValue) {
                    fieldFlowElement += `<div class="field-row">
                                            <div class="field-label">
                                                ...
                                                <div class="recordFieldEditOuter" data-record-id="${APP.selectedRecord.id}" data-field-api="${field}" onclick='APP.editPopupDiv(event, "${contactId.trim()}", "${recordModule+"s"}", "${APP.selectedRecord.id}", "${field}");'>
