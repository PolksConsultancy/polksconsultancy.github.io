    ...
    return {
        embeddedApp: {
            ...
            init: function() {
                if (!h) {
                    ...
                    c.OnLoad(function() {
                        c.getContext().Event.Trigger("ZDK_EVENT", {
                            action: "get_zdk_url"
                        }, !0).then(function(k) {
                            self._zdksdk = c;
                    ...
                    for (var t in m)
                        c.getContext().Event.Listen(t, m[t])
                }
                return n
            }
        },
        CRM: function() {
            ...
            function u(a) {
                ...
                a.ID ? d.ID = a.ID : a.Type && (d.Type = a.Type,
            ...
            return {
                ...
                API: {
                    ...
                    getApprovalRecords: function(a) {
                        var b = {};
                        a ? a.action = "GET_APPROVAL_RECORDS" : (b.action = "GET_APPROVAL_RECORDS",
                        a = b);
                        return h(a)
                    },
...
var ZSDKUtil = function(c) {
  ...
  , ZSDKMessageManager = function(c) {
    ...
    function k(a, b, c) {
        l.hasOwnProperty(a) && (b ? l[a].resolve(c) : l[a].reject(c),
        l[a] = void 0,
        delete l[a])
    }
    function y(a) {
    ...
    c.SendRequest = function(a) {
        if (!a || "object" !== typeof a)
            throw Error("Invalid Options passed");
        var b;
        b = "Promise" + u++;
        a = {
            type: "SDK.EVENT",
    ...
    c.TriggerEvent = function(a, b, c) {
        if (!a)
            throw Error("Invalid Eventname : ", a);
  ...
  , ZSDKEventManager = function(c) {
    ...
    c.AttachEventListener = function(c, b) {
        "function" === typeof b && (Array.isArray(h[c]) || (h[c] = []),
        h[c].push(b))
    }
    ;
    c.NotifyEventListeners = function(c, b, t) {
        ...
        if ((k = h[b]) && Array.isArray(k))
            ...
            m.Info("Cannot find EventListeners for Event : ", b)
    }
    ;
    c.NotifyInternalEventHandler = function(c, b) {
        var h = b.eventName;
        "__APP_INIT__" === h ? (c.SetContext(b.data),
        c.ExecuteLoadHandler()) : "__APP_CONTEXT_UPDATE__" === h && (c.UpdateContext(b.data),
        c.ExecuteContextUpdateHandler())
    }
    ;
    return c
...
function ZSDK() {
    function c() {
        "function" !== typeof l ? z.Error("No OnLoad Handler provided to execute.") : C ? z.Error("OnLoad event already triggered.") : (l.call(q, q),
        C = !0)
    }
    function m() {
        a.call(q, q)
    ...
    function b(a) {
        ...
        if ("undefined" !== typeof ZSDKModelManager) {
            for (var c in b)
                ZSDKModelManager.AddModel(c, b[c]);
        ...
        for (b in a)
            if (a.hasOwnProperty(b)) {
                ...
                if (a[b].hasAttribute("data-options")) {
                    var d = JSON.parse(JSON.stringify(eval("(" + a[b].getAttribute("data-options") + ")"))), e = Object.keys(d), f;
                    for (f in e)
                        c = g(c, "${" + e[f] + "}", d[e[f]])
                }
                a[b].innerHTML = c
